...
public final class AVCaptureMicrophoneCapturer: NSObject, MicrophoneCapturing {
    ...
    private let outputQueue = DispatchQueue(label: "app.optirecord.capture.microphone.output")
    private let sessionQueue = DispatchQueue(label: "app.optirecord.capture.microphone.session")
