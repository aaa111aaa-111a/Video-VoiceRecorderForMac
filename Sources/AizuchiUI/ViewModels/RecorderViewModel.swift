...
/// pipeline. See `Tests/AizuchiUITests/RecorderViewModelTests.swift`.
@MainActor
public final class RecorderViewModel: ObservableObject {
    ...
    private static let selectedTargetKey = "app.aizuchi.selectedCaptureTarget.v1"
    private static let recentRecordingsKey = "app.aizuchi.recentRecordings.v1"
