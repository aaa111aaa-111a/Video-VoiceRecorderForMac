...
/// What the UI talks to. `RecordingCoordinator` (OptiRecordRecording) is the real
/// implementation; `PreviewRecordingController` (OptiRecordUI) fakes it for SwiftUI previews.
///
